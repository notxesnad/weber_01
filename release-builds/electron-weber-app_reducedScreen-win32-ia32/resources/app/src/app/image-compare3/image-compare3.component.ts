...
@Component({
  selector: 'app-image-compare3',
  templateUrl: './image-compare3.component.html',
  styleUrls: ['./image-compare3.component.css']
})
export class ImageCompare3Component implements OnInit {
...
/*
		...
		let elementWidth = document.querySelector('.wrapper').offsetWidth;
		active = "middle";
		scrollIt(elementWidth/3*2);
		active = "top";
		scrollIt(elementWidth/3);
		active = false;
